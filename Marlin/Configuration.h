...
#define STRING_CONFIG_H_AUTHOR "(me, hypercube)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.1993, 160.1993, 1609.5331, 279.52, 281.38 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 33, 10, -3.27 }
